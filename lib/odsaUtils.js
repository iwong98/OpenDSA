...
(function($) {
  ...
  $(document).ready(function() {
    ...
    function textToSpeech() {
      ...
      u.text = speechText;
     // Stops the narration before starting a new one.
      if(amISpeaking === true) {
        synth.cancel();
      }
      synth.speak(u);
      ...
      return function() {
        ...
        //Setting current slide text
          ...
          if($(this).closest(".jsavcontainer").attr("id") === closestContainer) {
            ...
            $(this).closest(".jsavcontainer").trigger("jsav-message", [$(this).closest(".jsavcontainer").find(".jsavoutput").text(), "true"]);
          }else{
            //Second SlideShow "avembed" type
            $(this).closest("#container").find(".jsavcontainer").trigger("jsav-message", [$(this).closest("#container").find(".jsavoutput").text(), "true"]);
          }
...
/////////////////////////////////////
    ...
    $(window).load(function() {
      ...
      $(".jsavcontainer").on("jsav-message", function(on, msg) {
        ...
        speechText = msg.replace(/<[^>]*>/g, "");
      });
       // Add the sound functionality to the forward button
      $(".jsavforward").click(function() {
        if($(this).closest("div[class='jsavcontrols']").prev().find("button").attr("voice") === "true") {
          textToSpeech();
        }
      });
        // Add the sound functionality to the backward button
      $(".jsavbackward").click(function() {
        if($(this).closest("div[class='jsavcontrols']").prev().find("button").attr("voice") === "true") {
          textToSpeech();
        }
      });
        // Add the sound functionality to the begin button
      $(".jsavbegin").click(function() {
        if($(this).closest("div[class='jsavcontrols']").prev().find("button").attr("voice") === "true") {
          textToSpeech();
        }
      });
        // Add the sound functionality to the end button
