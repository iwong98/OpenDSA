...
///////////////////////speech
    function textToSpeech() {
      ...
      u.text = document.getElementsByClassName("jsavoutput jsavline")[0].textContent;
      u.lang = "en-US";
      u.rate = 1.0;
      if(amISpeaking === true) {
        synth.cancel();
    ...
    var soundSettings = function(){
      return function() {
        var  $elem = $("<span class='jsavrow'><button class='sound'></button></span>");
        ...
        $elem.find("button").click(function() {
          soundControl.call();
          $(this).toggleClass("soundOff", voice === true);
          $(this).toggleClass("sound", voice === false);
        });
        return $elem;
      };
    };
    $(".jsavsettings").wrap("<span id='new'></span>");
