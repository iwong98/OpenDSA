    ...
    var soundSettings = function(){
      return function() {
        ...
        //Setting current slide text
          var currentSlide = $(this).closest(".jsavcontainer").attr("id");
          $("#" + currentSlide).trigger("jsav-message", [$("#" + currentSlide).find(".jsavoutput").text(), "true"]);
        //Switching OFF the sound button for other containers.
