...
///////////////////////speech
    ...
    var soundSettings = function(){
      return function() {
        var $elem = $("<span class='jsavrow'><button class='soundOff'></button></span>");
          $elem.find("button").attr("voice","false");
        var soundControl = function() {
            if($elem.find("button").attr("voice")==="true"){
                $elem.find("button").attr("voice","false");
            } else { 
                $elem.find("button").attr("voice","true");
            }
        ...
        $elem.find("button").click(function() {
            if(SpeechId != null)
            {
                if($(this).closest('div[class="ssAV jsavcontainer"]').attr('id') !== SpeechId){
    ...
    $(".jsavsettings").wrap("<span class='new'></span>");
    ...
    window.onload = function() {
      $(".jsavforward").click(function() {
          if($(this).closest('div[class="jsavcontrols"]').prev().find("button").attr("voice") === "true")
           {
              if((($(this).closest('div[class="ssAV jsavcontainer"]').attr('id') !== SpeechId)) || ($(this).closest('div[class="ssAV jsavcontainer jsavplaying"]').attr('id') !== SpeechId)){
                    if($(this).closest('div[class="ssAV jsavcontainer"]').attr('id') !== SpeechId) {
                        SpeechId = $(this).closest('div[class="ssAV jsavcontainer jsavplaying"]').attr('id');
                    } else {
                        SpeechId = $(this).closest('div[class="ssAV jsavcontainer"]').attr('id');
                    }
                }
